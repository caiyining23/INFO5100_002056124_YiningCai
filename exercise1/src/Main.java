...
public class Main {
    public static void main(String[] args) {
        ...
        // Add 20 students (some part-time, some full-time) to the session
        session.addStudent(new PartTimeStudent("Alice", quizScores1));
        session.addStudent(new FullTimeStudent("Bob", quizScores2, 92, 88));
        session.addStudent(new PartTimeStudent("Charlie", quizScores1));
        session.addStudent(new FullTimeStudent("David", quizScores2, 80, 85));
        session.addStudent(new PartTimeStudent("Eve", quizScores1));
        session.addStudent(new FullTimeStudent("Frank", quizScores2, 89, 92));
        session.addStudent(new PartTimeStudent("Grace", quizScores1));
        session.addStudent(new FullTimeStudent("Henry", quizScores2, 87, 90));
        session.addStudent(new PartTimeStudent("Ivy", quizScores1));
        session.addStudent(new FullTimeStudent("Jack", quizScores2, 91, 93));
        session.addStudent(new PartTimeStudent("Kevin", quizScores1));
        session.addStudent(new FullTimeStudent("Laura", quizScores2, 85, 90));
        session.addStudent(new PartTimeStudent("Mona", quizScores1));
        session.addStudent(new FullTimeStudent("Nick", quizScores2, 88, 92));
        session.addStudent(new PartTimeStudent("Olivia", quizScores1));
        session.addStudent(new FullTimeStudent("Paul", quizScores2, 83, 86));
        session.addStudent(new PartTimeStudent("Quincy", quizScores1));
        session.addStudent(new FullTimeStudent("Rachel", quizScores2, 90, 95));
        session.addStudent(new PartTimeStudent("Steve", quizScores1));
        session.addStudent(new FullTimeStudent("Tom", quizScores2, 84, 88));
